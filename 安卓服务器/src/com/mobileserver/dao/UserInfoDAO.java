...
public class UserInfoDAO {
	...
	public List<UserInfo> QueryUserInfo(String user_name,String realName,Timestamp birthday,String cardNumber,String city) {
		...
		try {
			...
			while (rs.next()) {
				...
				userInfo.setMoney(rs.getFloat("money"));
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		try {
			/* 构建sql执行插入新用户信息 */
			String sqlString = "insert into UserInfo(user_name,password,realName,sex,birthday,cardNumber,city,money,photo,address) values (";
