...
public class GuestBookUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (username == null) {
			...
			setTitle("您好：" + username + "   当前位置---我的留言");
		}
		/*
		...
		*/
		queryConditionGuestBook = new GuestBook();
		queryConditionGuestBook.setUserObj(username); 
		queryConditionGuestBook.setTitle("");
		setViews();
	}
	...
	private void setViews() {
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	intent.setClass(GuestBookUserListActivity.this, GuestBookDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑留言信息信息
			...
			Intent intent = new Intent();
			intent.setClass(GuestBookUserListActivity.this, GuestBookEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("guestBookId", guestBookId);
			intent.putExtras(bundle);
			startActivity(intent);
			GuestBookUserListActivity.this.finish();
	...
	protected void dialog() {
		Builder builder = new Builder(GuestBookUserListActivity.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == 1) {
			// 添加留言信息信息
			Intent intent = new Intent();
			intent.setClass(GuestBookUserListActivity.this, GuestBookUserAddActivity.class);
			startActivity(intent);
			GuestBookUserListActivity.this.finish();
		} else if (item.getItemId() == 2) {
			/*返回主界面*/
			Intent intent = new Intent();
			intent.setClass(GuestBookUserListActivity.this, MainMenuUserActivity.class);
			startActivity(intent);
			GuestBookUserListActivity.this.finish();
		}
		return true; 
